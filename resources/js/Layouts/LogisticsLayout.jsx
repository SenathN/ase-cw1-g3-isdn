...
export default function LogisticsLayout({ header, children }) {
    ...
    const navigation = [
        ...
        { name: 'Products', route: 'logistics.products.index', current: 'logistics.products.*' },
        { name: 'Delivery Schedules', route: 'logistics.schedules.index', current: 'customer.tracking.*' },
        { name: 'Driver Management', route: 'logistics.drivers.index', current: 'customer.tracking.*' },
    ];
